...
export default function TestScreen() {
    ...
    const wipeNdefResetFileSettings = async (masterKey: any) => {
        //RESET FILE SETTINGS
        try {
            // register for the NFC tag with NDEF in it
    ...
    const changeKey = async () => {
        try {
            ...
            const { sesAuthEncKey, sesAuthMacKey, ti } = await Ntag424.AuthEv2First("00", key0);
            console.log("key1");

            await Ntag424.changeKey("01", key0, "22222222222222222222222222222222", "01");
            console.log("key2");
            await Ntag424.changeKey("02", key0, "33333333333333333333333333333333", "01");
            console.log("key3");
            await Ntag424.changeKey("03", key0, "44444444444444444444444444444444", "01");
            console.log("key4");
            await Ntag424.changeKey("04", key0, "55555555555555555555555555555555", "01");
            console.log("key0");
            await Ntag424.changeKey("00", key0, "11111111111111111111111111111111", "01");
        } catch (ex) {
            console.warn("Oops!", ex);
        } finally {
            // stop the nfc scanning
    ...
    const resetKey = async () => {
        try {
            ...
            console.log("key1");
            await Ntag424.changeKey("01", "22222222222222222222222222222222", defaultkey, "00");
            console.log("key2");
            await Ntag424.changeKey("02", "33333333333333333333333333333333", defaultkey, "00");
            console.log("key3");
            await Ntag424.changeKey("03", "44444444444444444444444444444444", defaultkey, "00");
            console.log("key4");
            await Ntag424.changeKey("04", "55555555555555555555555555555555", defaultkey, "00");
            console.log("key0");
            await Ntag424.changeKey("00", "11111111111111111111111111111111", defaultkey, "00");
        } catch (ex) {
            console.warn("Oops!", ex);
        } finally {
            // stop the nfc scanning
    ...
    const writeNdefSetFileSettings = async (masterKey: any, ndefMessage: any) => {
